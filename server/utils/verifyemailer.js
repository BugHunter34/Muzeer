            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:580px;background:#0b1020;border:1px solid #1e293b;border-radius:12px;overflow:hidden;">
              <tr>
                <td style="padding:26px 26px 12px 26px;text-align:center;">
                  ...
                  <h1 style="margin:10px 0 0 0;color:#f8fafc;font-size:28px;line-height:1.25;">Verify your email</h1>
                </td>
              </tr>
              <tr>
                <td style="padding:2px 26px 0 26px;text-align:center;color:#e2e8f0;font-size:18px;font-weight:600;line-height:1.4;">
                  Hello, ${userName}
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td style="padding:14px 26px 24px 26px;text-align:center;color:#64748b;font-size:11px;line-height:1.6;">
                  If the button doesn't work, copy and paste this URL into your browser:<br />
                  <a href="${verifyLink}" style="color:#3b82f6;text-decoration:none;word-break:break-all;">${verifyLink}</a>
                </td>
              </tr>
            </table>
          </td>
